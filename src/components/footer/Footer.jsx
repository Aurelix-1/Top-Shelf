  ...
  return (
    <footer className="footer">
      <div className="coupon-card">
        ...
        <p className="coupon-subtitle">Reveal coupon code by entering your email</p>
      ...
      <div className="footer-main">
        <div className="footer-brand">
          ...
          <p className="footer-desc">
            #1 Canadian top rated online dispensary that meets the customers needs in
            every single medical marijuana aspect. The team here at TopShelfBC is
